...
struct Cart
{
    ...
    private:
        ...
        const std::map<std::array<uint32_t, 5>, cartAttributes> cartInfo
        {
            ...
            //1
            {{0xC1A8F6A9, 0x31608048, 0x7CFEACA6, 0x2F3D573C, 0xD9D484E9}, {Ntsc   , NES_SFROM   , 128, 32 , 0, 0, 0, single    , MMC1A }}, //bubble bobble
            ...
            {{0x6E85261D, 0x5FE84846, 0x80DECD2D, 0x5EDC3194, 0x65887D2A}, {Ntsc   , NES_SLROM   , 128, 128, 0, 0, 0, single    , MMC1B2}}, //rad gravity
            {{0x4C6D53EF, 0xFDB90A42, 0x1F8E92C1, 0x1738DD2A, 0xF2EC4495}, {Ntsc   , NES_SLROM   , 128, 128, 0, 0, 0, single    , MMC1B2}}, //S W A M P A S S
            ...
            {{0xC9CFBF54, 0x55085E19, 0x8DCE0392, 0x98B083CD, 0x6FC88BCE}, {Ntsc   , NES_SNROM   , 256, 8  , 1, 8, 1, single    , MMC1B2}}, // final fantasy
