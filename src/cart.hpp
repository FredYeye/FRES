...
enum Type : uint16_t {NES_NROM = 0, NES_SLROM = 1, NES_SGROM = 1, NES_UNROM = 2, NES_CNROM = 3, NES_AOROM = 7, KONAMI_VRC_4 = 21};
...
struct Cart
{
    ...
    private:
        ...
        const std::map<std::array<uint32_t, 5>, cartAttributes> cartInfo
        {
            ...
            //blaster master can have mmc1a or mmc1b, maybe do something about that later
